...
const SixSection = () => {
	return (
		<div className={styles.power_up__section_wrapper}>
			<div className={`${styles.power_up_container} container`}>
					...
					<article className={styles.power_up__left_block}>
						...
						<AnimationOnScroll delay={100} animateIn="animate__fadeIn">
							<p className={styles.left_block__text}>
								We're building a new paradigm of urban mobility that understands and adapts to the world
								around it. We empower cities with dynamic tools to make streets safer, less congested, and
								more productive.
							</p>
						</AnimationOnScroll>
					</article>
